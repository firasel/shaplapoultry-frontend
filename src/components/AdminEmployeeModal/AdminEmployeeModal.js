...
const AdminEmployeeModal = ({ modalState, id }) => {
  ...
  const onSubmit = async (data) => {
    ...
    await fetch(`https://shaplapoultrysapi.herokuapp.com/user/delete`, {
      method: "POST",
      headers: {
      ...
      .then((data) => {
        if (data.status === true) {
          ...
          dispatch(setAnyDataChange(!anyDataChange));
        } else {
