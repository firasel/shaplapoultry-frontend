...
import "./BricksModal.scss";

const BricksModal = ({ modalState, anyDelete, id }) => {
  ...
  const onSubmit = async (data) => {
    ...
    await fetch(`https://shaplapoultrysapi.herokuapp.com/bricks/delete`, {
      method: "POST",
      headers: {
